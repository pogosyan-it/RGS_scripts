...
dnf install glibc-langpack-en nano nfs-utils apr apr-util -y
...
echo "Dis:/export/pgsql /opt/pgsql nfs exec,ro        0 0" >> /etc/fstab
echo "Dis:/export/oracle /opt/oracle nfs exec,ro        0 0" >> /etc/fstab
echo "Dis:/export/share /export/share nfs noauto,noexec,rw        0 0" >> /etc/fstab
...
mount /export/share
cat /export/share/sysctl.net >> /etc/sysctl.conf
sysctl -p
