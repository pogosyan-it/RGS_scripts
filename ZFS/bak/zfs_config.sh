...
yum install tcsh git glibc-langpack-ru wget rsync lz4 bzip2 unzip zip tar telnet-server ethtool time tcpdump iotop lsof binutils gcc m4 bison make redhat-rpm-config xinetd gdb -y
